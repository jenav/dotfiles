...
M.style = function()
	...
	-- void, intptr_t
	highlight(0, "Type", { link = "ZiggyGrey89" })
	...
	highlight(0, "@constant", { link = "ZiggyRed" })
	highlight(0, "@constant.builtin", { link = "ZiggyRed" })
	...
	highlight(0, "@keyword.exception", { fg = white, bold = true })
	...
	highlight(0, "@variable.builtin", { link = "ZiggyGrey89" })
